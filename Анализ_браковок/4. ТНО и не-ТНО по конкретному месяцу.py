...
# в столбцах 'Количество', 'ПРИЧИНА', 'ВИНОВНИК' заменяем NaN на 0 и изменяем тип данных  на целочисленный
df[["Количество", "ПРИЧИНА", "ВИНОВНИК"]] = df[["Количество", "ПРИЧИНА", "ВИНОВНИК"]].fillna(0).astype("int16")
