...
class PDFProcessorYMZ:
    ...
    def count_not_found(self):
        """Подсчет количества значений 'Не найдено' в данных"""
        return sum(1 for value in self.data.values() if value == "Не найдено")
    ...
    def parse_text(self, text):
        """
        Парсинг текста и заполнение словаря данных
        """
