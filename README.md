#### В репозитории находятся действующие проекты, созданные для автоматизации поиска по базе данных дефектых изделий (таблицам Excel) и анализа полученной информации.
