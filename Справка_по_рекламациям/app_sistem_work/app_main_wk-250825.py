...
class MainApplication:
    def __init__(self, root):
        ...
        self.footer_label = ttk.Label(root, text=f"Development by IGOR VASILENOK - версия {app_version}  ", anchor='e')
        ...
        self.buttons = [
            ("Аналитика базы ОТК",
             ...
             "- справка о количестве признанных / непризнанных рекламаций накопительным итогом с начала года;\n" +
    ...
    def open_defects_analysis_window(self):
        ...
        window.title("Анализ актов о браке")
    ...
    def show_about(self):
        messagebox.showinfo("О программе",
                          f"Аналитическая система Управления качества БЗА\nВерсия {app_version}\n\n" +
                          "Система состоит из приложений для анализа и обработки данных по рекламациям и дефектности.\n\n\n" +
                          "Идея и реализация - Василёнок Игорь и claude-3-5-sonnet-20241022")
