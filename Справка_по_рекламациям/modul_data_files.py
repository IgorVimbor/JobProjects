...
"//Server/otk/АНАЛИТИЧЕСКАЯ_СИСТЕМА_УК/MyDatabase_and_logs/Справка по рекламациям за период_база_данных.txt"
...
database = "//Server/otk/АНАЛИТИЧЕСКАЯ_СИСТЕМА_УК/MyDatabase_and_logs/Справка по рекламациям за период_база_данных.txt"
...
res_file_txt = "//Server/otk/АНАЛИТИЧЕСКАЯ_СИСТЕМА_УК/MyDatabase_and_logs/Справка по рекламациям за период.txt"
...
res_file_excel = "//Server/otk/АНАЛИТИЧЕСКАЯ_СИСТЕМА_УК/Справка по рекламациям за период.xlsx"
...
class MakeResultDataframe(TextDatabaseLoader):
    ...
    Класс MakeResultDataframe наследуется от класса TextDatabaseLoader для использования значений переменных
    инициированных в родительском классе.
    """
...
class WriteResult(MakeResultDataframe):
    ...
    Класс WriteResult наследуется от класса MakeResultDataframe (который сам наследуется от класса TextDatabaseLoader)
    для использования значений переменных инициированных в родительских классах.
    """
