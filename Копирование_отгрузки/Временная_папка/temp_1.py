...
class Copy_value:
    ...
    def copy_garant(self):
        ...
        num_col_asp = {
            "январь": 2, "февраль": 3, "март": 4, "апрель": 5, "май": 6, "июнь": 7, "июль": 8, 
            "август": 9, "сентябрь": 10, "октябрь": 11, "ноябрь": 12,  "декабрь": 13,
        }
        num_col_zap = {
            "январь": 14, "февраль": 15, "март": 16, "апрель": 17, "май": 18, "июнь": 19, "июль": 20,
            "август": 21, "сентябрь": 22, "октябрь": 23, "ноябрь": 24, "декабрь": 25,
        }
