...
from accept_defect_app import AcceptDefect
from length_study_app import LengthStudyWindow
from not_acts_app import NotActsWindow
from pretence.pretence_app import PretenceDateAct
...
class AnalyticsApp(tk.Tk):
    def __init__(self, master=None):
        ...
        links_data = [
            ("Количество признанных / непризнанных рекламаций",
            ...
            ("Незакрытые акты рекламаций по АСП и Эксплуатации",
