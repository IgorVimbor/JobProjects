...
df_2023 = pd.read_excel(file,
                        sheet_name='2023',
                        usecols=['Период выявления дефекта (отказа)',
                                 'Наименование изделия',
                                 'Дата изготовления изделия'],
                        header=1)   # читаем файл Excel и создаем датафрейм
# print(df_2023.head())
# print(df_2023.shape)  # (884, 3)

df_2022 = pd.read_excel(file,
                        sheet_name='2022',
                        usecols=['Период выявления дефекта (отказа)',
                                 'Наименование изделия',
                                 'Дата изготовления изделия'],
...
ymz_2023 = df_2023[(df_2023['Период выявления дефекта (отказа)'] == client)
                   &
...
ymz_2022 = df_2022[(df_2022['Период выявления дефекта (отказа)'] == client)
                   &
...
ymz_2021 = df_2021[(df_2021['Период выявления дефекта (отказа)'] == client)
                   &
