...
class AcceptDefect(tk.Toplevel):
    ...
    def process_data(self):
        ...
        self.year_now = paths_home.year_now  # текущий год
        self.date_new = paths_home.date_new  # сегодняшняя дата
        self.file = paths_home.file_database  # путь к базе данных ОТК
        self.file_txt = paths_home.accept_defect_otchet  # путь к файлу с отчетом
