...
# открываем файл ОТК и нужный Лист
...
class DataCopierGarant:
    ...
    def copy_garant(self):
        ...
        ws3 = wb3["Данные2"]  # открываем лист "Данные2" в файле ОТК
