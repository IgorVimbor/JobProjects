...
class UniversalExcelExporter:
    ...
    def _get_field_value(self, reclamation, field_key):
        """Упрощенное получение значения поля"""
        ...
        try:
            if field_type == "direct":
                ...
                # ИСПРАВЛЕНИЕ: специальная обработка для дат в претензиях
    ...
    def _apply_date_formatting(self):
        """Исправленное форматирование дат"""
        date_columns = []
    ...
    def _write_data(self):
        """Запись данных с упрощенной логикой"""
