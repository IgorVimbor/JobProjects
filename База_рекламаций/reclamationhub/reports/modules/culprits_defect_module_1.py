...
class CulpritsDefectProcessor:
    ...
    def __init__(self, user_number=None):
        ...
        if user_number is not None:
            ...
            self.start_act_number = self.max_act_number + 1
    ...
    def _load_act_numbers_from_json(self):
        ...
        try:
            ...
            # Находим номер последнего акта из JSON файла
            # - если справка за отчетный период (прошлый месяц) делалась - номер акта прошлого месяца.
            # - если справка за отчетный период не делалась - номер акта позапрошлого месяца.
            self.max_act_number = self.dct_act_numbers.get(
                self.prev_month.month, self.dct_act_numbers[prev_prev_month.month]
            )
    ...
    def get_default_act_number(self):
        ...
        """
        return self.start_act_number, self.max_act_number
    ...
    def generate_analysis(self):
        ...
        try:
            ...
            return {
                ...
                "start_act_number": self.start_act_number,  # С какого акта начали
