...
- `claim_prognosis_processor_old.py` — 
  Процессор для прогнозирования претензий с методами статистического анализа и машинного обучения.  
  Включает класс:  
...
- `claim_prognosis_old.py` — Представление для страницы прогнозирования претензий
...
- `claims\claim_prognosis_old.html` — Шаблон страницы с формой прогнозирования претензий
...
- `claims\blocks\prognosis_results_old.html` — Блок результатов прогноза рекламаций и претензий
...
│   │   ├──  claim_prognosis_processor_old.py  # Процессор для прогнозирования претензий с методами статистического анализа и машинного обучения.
...
│   │       │   ├──  prognosis_results_old.html  # Блок результатов прогноза рекламаций и претензий
...
│   │       ├──  claim_prognosis_old.html  # Шаблон страницы с формой прогнозирования претензий
