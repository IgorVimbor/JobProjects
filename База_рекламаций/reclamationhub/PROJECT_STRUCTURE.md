...
- `about_page.py` — Представление для страницы 'О проекте'.
- `home_page.py` — Представление для главной страницы сайта с данными текущего года.
...
│   │   └──  search_mixin.py  # Логика для поиска по номеру изделия и двигателя.
│   ├── templates/  # Шаблоны
│   │   └── core/
...
│   ├── templatetags/
│   │   ├──  __init__.py
│   │   └──  search_tags.py  # Пользовательские теги (Template tags) шаблонов для работы с поиском в админке.
│   ├── views/  # Представления
│   │   ├──  __init__.py
│   │   ├──  about_page.py  # Представление для страницы 'О проекте'.
│   │   └──  home_page.py  # Представление для главной страницы сайта с данными текущего года.
...
│   ├── admin/
│   │   ├── css/
│   │   │   └──  custom_admin.css  # ========== ОБЩИЕ СТИЛИ ДЛЯ ТАБЛИЦ В АДМИН-ПАНЕЛИ ==========
│   │   └── js/
