...
"""Процессор для анализа конверсии рекламация → претензия (ИСПРАВЛЕННЫЙ)"""
...
class ReclamationToClaimProcessor:
    ...
    def _build_dataframe(self):
        """
        Строим pandas DataFrame один раз для всех вычислений
        ...
        - claim_id
        - claim_date
        - consumer (полное название)
        - consumer_prefix (префикс)  ← НОВОЕ
        - days
        """
