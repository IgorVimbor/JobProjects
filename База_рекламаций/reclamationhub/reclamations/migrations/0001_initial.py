    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_number', models.CharField(blank=True, max_length=10, null=True, verbose_name='Заводской номер изделия')),
                ...
                ('consumer_act_number', models.CharField(blank=True, max_length=100, null=True, verbose_name='Номер рекламационного акта приобретателя изделия')),
                ('consumer_act_date', models.DateField(blank=True, null=True, verbose_name='Дата рекламационного акта приобретателя изделия')),
                ...
                ('end_consumer_act_number', models.CharField(blank=True, max_length=100, null=True, verbose_name='Номер рекламационного акта конечного потребителя')),
                ('end_consumer_act_date', models.DateField(blank=True, null=True, verbose_name='Дата рекламационного акта конечного потребителя')),
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reclamations', to='sourcebook.product', verbose_name='Изделие')),
            ],
            options={
